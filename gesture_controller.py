...
class Controller:
    ...
    def changesystembrightness():
        """
        Adjusts system brightness using keyboard keys.
        ...
        try:
            ...
            print("Brightness key control error:", e)


    def changesystemvolume():
        """
        Adjusts system volume using keyboard keys.
        Reliable on all Windows systems.
        """
        try:
            if Controller.pinchlv > 0:
            ...
            print("Volume key control error:", e)
